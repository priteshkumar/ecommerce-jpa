...
public class FakeStoreProductGateway implements IProductGateway {
  ...
  public ProductDTO getProduct(int id) throws ProductNotFoundException, IOException {
    SingleProductResponseDTO response = this.fakeStoreCategoryApi.getProduct(id).execute().body();
  ...
  public List<ProductDTO> getAllProductsByCategory(String type) throws IOException {
    ...
    if (response == null) {
      throw new IOException("Failed to fetch category products from " + "FakeStore API");
    }
