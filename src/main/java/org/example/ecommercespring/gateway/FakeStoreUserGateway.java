...
public class FakeStoreUserGateway implements IUserGateway {
  ...
  public UserDTO getUser(int id) throws IOException {
    ...
    if (response.isSuccessful()) {
      ...
      throw new IOException("Failed to fetch user from " + "FakeStore API");
    }
  }
}
