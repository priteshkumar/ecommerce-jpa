...
public class FakeStoreRestTemplateGateway implements ICategoryGateway {
  ...
  public List<CategoryDTO> getAllCategories() throws IOException {
    ...
    String fakestoreCategoryurl = this.fakestoreapiUrl + "products" + "/category";
    FakeStoreCategoryResponseDTO response =
        this.restTemplate.getForObject(fakestoreCategoryurl, FakeStoreCategoryResponseDTO.class);
    if (response == null) {
